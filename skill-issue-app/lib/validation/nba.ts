...
const playerIndexRow = z.object({
  ...
  TEAM_CITY: z.string().nullable(),
  TEAM_NAME: z.string().nullable(),
  POSITION: z.string().nullable(),
  JERSEY_NUMBER: z.string().nullable(),
  ROSTER_STATUS: z.coerce.number().nullable(),
...
const playerGameLogRow = z.object({
  ...
  FGM: z.coerce.number().nullable(),
  FGA: z.coerce.number().nullable(),
  PTS: z.coerce.number().nullable(),
  OREB: z.coerce.number().nullable(),
  DREB: z.coerce.number().nullable(),
  REB: z.coerce.number().nullable(),
  AST: z.coerce.number().nullable(),
  STL: z.coerce.number().nullable(),
  BLK: z.coerce.number().nullable(),
  TOV: z.coerce.number().nullable(),
  PF: z.coerce.number().nullable(),
  FG_PCT: z.coerce.number().nullable(),
  FG3M: z.coerce.number().nullable(),
  FG3A: z.coerce.number().nullable(),
  FT_PCT: z.coerce.number().nullable(),
  FTM: z.coerce.number().nullable(),
  FTA: z.coerce.number().nullable(),
  FG3_PCT: z.coerce.number().nullable(),
  PLUS_MINUS: z.coerce.number().nullable(),
  VIDEO_AVAILABLE: z.coerce.number().nullable(),
});
